                                  ...
                                  translationSpeed( 0.0015 )
{
    ...
    timerNuevaImagen->setInterval( Comun::getInstance()->getTimerEscena() );
...
void Scene::setTimerNuevaImagen(int milisegundos)
{
    timerNuevaImagen->setInterval( milisegundos );
}
...
//    conPlantilla_o_sinPlantilla = "_imagenes/";
    ...
    QDir directory( "../fotos/" + Comun::getInstance()->getHashTag() + conPlantilla_o_sinPlantilla );
    ...
    for ( int i = 0; i < imageFiles.size(); i++ )
    {
        ...
        QString textureUri( "../fotos/" + Comun::getInstance()->getHashTag() + conPlantilla_o_sinPlantilla + imageFiles.at( i ) );
